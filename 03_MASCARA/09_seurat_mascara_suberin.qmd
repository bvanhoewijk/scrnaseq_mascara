...
dirs <- setNames(c("../02_scRNA_analysis/data/run_count_rep1/outs/filtered_feature_bc_matrix/", "../02_scRNA_analysis/data/run_count_rep1/outs/filtered_feature_bc_matrix/"), c("rep1", "rep2"))
...
```{r}
pbmc <- subset(pbmc, subset = nFeature_RNA > 300 & nFeature_RNA < 9000 & percent.MT < 20)
pbmc
```
```{r}
...
pbmc_selection <- pbmc#pbmc[,suberin_expression_cells]
